...
public class StringUtils {
     ...
     * @param field 字段
     * @return 字段值
     * "name=zhangsan|age=18|money=100"   |   name
     */
...
//    	System.out.println(setFieldInConcatString("name=zhangsan|age=12","\\|","age","111"));
//    	System.out.println(getKeyValuesFromConcatString("name=zhangsan|age=12","\\|"));

        System.out.println("|nihao|haha".split("\\|").length);

        for(String str:"|nihao|haha".split("\\|")){
     ...
     * @return 字段值
     *  name=zhangsan|age=12|sex=1  |  age    18
     *
     *
     *
    ...
    public static String setFieldInConcatString(String str,
        ...
        for(int i = 0; i < fields.length; i++) {
            ...
            if(fieldName.equals(field)) {
                String concatField = fieldName + "=" + newFieldValue; //age=18
