...
public class GroupConcatDistinctUDAF extends UserDefinedAggregateFunction {
	...
	public void update(MutableAggregationBuffer buffer, Row input) {
		...
		// 刚刚传递进来的某个车辆信息
		String inputMonitorInfo = input.getString(0); //两种可能：第一种是0001，第二种是0001=1000|0002=2000|0003=3000
		
		String[] split = inputMonitorInfo.split("\\|");
		String monitorId = "";
		int addNum = 1;
		for (String string : split) {
		    //当input 输入数据是：0001=1000|0002=2000|0003=3000
			if(string.indexOf("=") != -1){
	...
	public void merge(MutableAggregationBuffer buffer1, Row buffer2) {
		//缓存中的monitor信息这个大字符串                        ""    0001=2000

		String bufferMonitorInfo1 = buffer1.getString(0);///0001=2000|0002=3000
		//传进来          
		String bufferMonitorInfo2 = buffer2.getString(0);//|0001=1000|0002=2000|0003=3000
		...
		for(String monitorInfo : bufferMonitorInfo2.split("\\|")) {
            ...
            for (Entry<String, String> entry : map.entrySet()) {
				String monitor = entry.getKey(); // buff2  0001,2000
